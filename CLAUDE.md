...
| **Phones are dirty** | **52%** of JSON `phone` values carry a trailing `x`/`x27`; 160 disagree with the CSV | Use CSV `phone_number` |
...
| **Neighborhoods are ambiguous** | 1,062 distinct; top value is **`Downtown` (185)** across many cities | Hierarchical facet `area > city > neighborhood` |
